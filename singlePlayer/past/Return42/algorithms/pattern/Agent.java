package tracks.singlePlayer.past.Return42.algorithms.pattern;

import tracks.singlePlayer.past.Return42.GameStateCache;
import tracks.singlePlayer.past.Return42.heuristics.patterns.EnemyPattern;
import tracks.singlePlayer.past.Return42.heuristics.patterns.Pattern;
...
public class Agent extends AbstractPlayer {
    ...
    public Agent(StateObservation so, ElapsedCpuTimer elapsedTimer) {
        ...
        fallback = new tracks.singlePlayer.past.Return42.algorithms.GA.Agent(so, elapsedTimer);
    }
