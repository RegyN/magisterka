...
public class LearningMachine {
    ...
    /**
     * Reads and launches a game for an agents to be played. Graphics can be on or off.
     *
     ...
     * @param cmd  array with name of the script file to run for the client, plus agents and port
...
//        System.out.println("LearningMachine required level="+level);
     ...
     *
     * @param cmd name of the script to execute, with parameters (agents name and port).
    ...
    /**
     * Creates a player given its name with package for multiplayer. This class calls the constructor of the agents
     * and initializes the action recording procedure. PlayerID used is 0, default for single player games.
     * @param playerName name of the agents to create. It must be of the type "<agentPackage>.Agent".
     * @param actionFile filename of the file where the actions of this player, for this game, should be recorded.
     * @param so Initial state of the game to be played by the agents.
     * @param randomSeed Seed for the sampleRandom generator of the game to be played.
