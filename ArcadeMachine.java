...
public class ArcadeMachine {
     ...
     * constructor of the agents and initializes the action recording procedure.
     * PlayerID used is 0, default for single player games.
     * 
     * @param playerName
     *            name of the agents to create. It must be of the type
     *            "<agentPackage>.Agent".
     * @param actionFile
     *            filename of the file where the actions of this player, for
     *            this game, should be recorded.
     * @param so
     *            Initial state of the game to be played by the agents.
     * @param randomSeed
     ...
     * calls the constructor of the agents and initializes the action recording
