...
public class SharedData {
	...
	/**
	 * the best automated agents
	 */
	public static AbstractPlayer automatedAgent;
	/**
	 * the naive automated agents
	 */
	public static AbstractPlayer naiveAgent;
	/**
	 * the do nothing automated agents
	 */
